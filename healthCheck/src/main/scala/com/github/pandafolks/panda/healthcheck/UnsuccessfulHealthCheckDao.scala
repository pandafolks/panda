...
trait UnsuccessfulHealthCheckDao {
   ...
   * @return                            Either a counter after incrementation or [[PersistenceError]] if the error occurred
   */
   ...
   *
   * @param identifier                  Unique identifier
   * @return                            Either empty if successful or [[PersistenceError]] if the error occurred
   */
