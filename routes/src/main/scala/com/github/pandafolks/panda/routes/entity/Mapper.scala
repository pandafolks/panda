...
final case class Mapper(route: String, mappingContent: MappingContent, httpMethod: HttpMethod, standalone: Boolean, lastUpdateTimestamp: Long)
...
object Mapper {
  ...
  final val STANDALONE_PROPERTY_NAME = "standalone"
