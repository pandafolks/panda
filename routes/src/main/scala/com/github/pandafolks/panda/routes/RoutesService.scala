...
trait RoutesService {
  ...
  /** Returns all [[entity.Mapper]] and [[entity.Prefix]] present in the persistence layer linked to the specified group name as a
  ...
  /** Saves all [[entity.Mapper]] and [[entity.Prefix]] delivered with the [[RoutesResourcePayload]]. The method discards all duplicates and
    * saves in the persistence layer only those that have been not present before.
    *
  ...
  /** Saves all [[entity.Mapper]] and [[entity.Prefix]] delivered with the [[RoutesResourcePayload]]. The method saves new entries and
    * updates those already present. Mapper recognition is made based on the route, Prefix recognition is made based on the group name.
    *
    * @param routesResourcePayload
    * @return
    *   Mappers and Prefixes creation results
  ...
  /** Removes all requested [[entity.Mapper]] and group [[entity.Prefix]]. Mappers distinction is made based on routes and the HTTP methods.
