...
trait ParticipantEventService {
   ...
   *
   * @param participantModificationPayload      Data transfer object with multiple configurable fields.
   ...
   */
  def createParticipant(participantModificationPayload: ParticipantModificationPayload): Task[Either[PersistenceError, String]]
   ...
   * @return                                    Either identifier if saved successfully or PersistenceError if the error during saving occurred
   */
  def modifyParticipant(participantModificationPayload: ParticipantModificationPayload): Task[Either[PersistenceError, String]]
