...
trait BackgroundJobsRegistry {
  ...
  /** Adds the action to the registry and runs it immediately as a periodic task that becomes enabled first after the
    * given initial delay, and subsequently with the given period. Executions will commence after initialDelay then
